...
//                      ];
      m_colorTable = [
                      {end: 0.083333, color: [0.0, 0.407843, 0.215686]},
                      {end: 0.166667, color: [0.0639811, 0.525948, 0.277195]},
                      {end: 0.250000, color: [0.177935, 0.633066, 0.332723]},
                      {end: 0.333333, color: [1.0, 1.0, 0.0]},
                      {end: 0.416667, color: [1.0, 0.666667, 0.0]},
                      {end: 0.500000, color: [0.973465, 0.547402, 0.318105]},
                      {end: 0.583333, color: [0.939025, 0.389929, 0.245518]},
                      {end: 0.666667, color: [0.921569, 0.356863, 0.227451]},
                      {end: 0.750000, color: [0.867659, 0.239826, 0.176623]},
                      {end: 0.833333, color: [0.762402, 0.110719, 0.151324]},
                      {end: 0.916667, color: [1.0, 0.0, 0.0]},
                      {end: 1.000000, color: [0.498039, 0.0, 0.0]},
                    ]
