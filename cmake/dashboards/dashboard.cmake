...
set(CTEST_PROJECT_NAME "OpenGeoscience")
...
set(CTEST_BINARY_DIRECTORY "${DASHROOT}/${CTEST_PROJECT_NAME}/builds/${PROJECT_BRANCH_DIRECTORY}/VisGUI-${PROJECT_BUILD_INTERVAL}-${PROJECT_BUILD_ARCH}")
set(CTEST_SOURCE_DIRECTORY "${DASHROOT}/${CTEST_PROJECT_NAME}/source/${PROJECT_BRANCH_DIRECTORY}/VisGUI-${PROJECT_BUILD_INTERVAL}-${PROJECT_BUILD_ARCH}")

# Prepare to do an initial checkout, if necessary
if(CTEST_UPDATE_COMMAND AND NOT EXISTS "${CTEST_SOURCE_DIRECTORY}")
  set(CTEST_CHECKOUT_COMMAND "${CTEST_UPDATE_COMMAND} clone -b ${PROJECT_BRANCH} git://public.kitware.com/OpenGeoscience/opengeoscience.git ${CTEST_SOURCE_DIRECTORY}")
endif()
